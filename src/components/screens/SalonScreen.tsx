      ...
      {tab === "about" && (
        <div className="flex flex-col gap-3 animate-fade-in">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[["26+", "лет работы"], ["15", "мастеров"], ["2000+", "клиентов"]].map(([num, label]) => (
          ...
          <div className="bg-white border border-[hsl(var(--border))] rounded-2xl px-4 py-3 shadow-sm">
            <p className="font-golos text-sm text-[hsl(var(--text-secondary))] leading-relaxed">
              Салон «Модерн» — семейный салон красоты в центре Городца. Основан <span className="font-semibold text-[hsl(var(--text-main))]">28 августа 1998 года</span>. Мастера регулярно проходят обучение, используем Olaplex, Kerastase, Redken, Schwarzkopf.
            </p>
          </div>
