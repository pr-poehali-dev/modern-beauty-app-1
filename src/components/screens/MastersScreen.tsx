...
const masters = [
  ...
  {
    name: "Елена Козлова", title: "Мастер маникюра", quote: "«Красивые руки — визитная карточка»",
    experience: "7 лет", rating: 4.9, reviews: 203, favorite: false,
    bio: "Сертифицированный мастер маникюра и педикюра. Работает с гель-лаками премиум класса, создаёт сложные дизайны и nail art.",
    specialties: ["Маникюр", "Педикюр", "Nail Art", "Гель-лак"],
    ...
    certs: [
      ...
      "Гель-лак и наращивание, CND Academy 2023",
      "Педикюр — медицинский подход, 2022",
    ],
    reviewsList: [
      ...
      { name: "Екатерина Б.", rating: 5, date: "8 мая 2026", text: "Хожу только к Лене уже больше года. Всегда слушает пожелания, предлагает интересные варианты дизайна. Маникюр держится идеально, ни одного скола за три недели." },
    ],
  },
  {
    name: "Ирина Захарова", title: "Мастер-бровист", quote: "«Брови меняют всё лицо»",
    experience: "5 лет", rating: 4.8, reviews: 156, favorite: false,
    bio: "Специалист по оформлению и окрашиванию бровей, ламинированию ресниц. Подбирает форму с учётом типа лица и пожеланий клиента.",
    specialties: ["Брови", "Архитектура бровей", "Окрашивание бровей", "Ресницы"],
    ...
    certs: [
      ...
      "Ламинирование ресниц и бровей, 2023",
      "Пигментация и окрашивание бровей, 2022",
    ],
    reviewsList: [
      { name: "Марина Ф.", rating: 5, date: "16 июня 2026", text: "Делала брови впервые — Ирина подобрала форму идеально под мой тип лица. Всё объяснила, показала варианты. Результат держится дольше, чем ожидала. Очень рекомендую!" },
      { name: "Юлия С.", rating: 5, date: "7 июня 2026", text: "Пришла с почти полным отсутствием бровей — вышла с красивой чёткой формой. Ирина настоящий художник! Подруги не поверили, что это мои родные брови." },
      { name: "Полина К.", rating: 5, date: "25 мая 2026", text: "Делала ламинирование ресниц — эффект потрясающий. Ресницы приподняты, взгляд открытый. Держится уже пятую неделю. Теперь хожу только к Ирине и на брови, и на ресницы." },
      { name: "Валерия М.", rating: 4, date: "14 мая 2026", text: "Отличная работа с окрашиванием бровей — оттенок подобрала идеально под мой цвет волос. Единственное — пришлось немного подождать, но результат того стоил." },
    ],
  },
];
